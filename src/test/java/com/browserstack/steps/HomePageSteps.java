...
public class HomePageSteps {
    ...
    public void iAddProductsToCart() {
        ...
        stepData.getWebDriver().findElement(By.cssSelector("#\\32 > .shelf-item__buy-btn")).click();
    }

    @And("I click on Buy Button")
    public void iClickOnBuyButton() {
        stepData.getWebDriver().findElement(By.cssSelector(".buy-btn")).click();
    }

    @And("I press the Apple Vendor Filter")
    public void iPressTheAppleVendorFilter() {
        stepData.getWebDriver().findElement(By.cssSelector(".filters-available-size:nth-child(2) .checkmark")).click();
    }

    @And("I order by lowest to highest")
    public void iOrderByLowestToHighest() {
        WebElement dropdown = stepData.getWebDriver().findElement(By.cssSelector("select"));
    ...
    public void iShouldSeeNoImageLoaded() {
        ...
        String src = "";
        try {
            src = stepData.getWebDriver().findElement(By.cssSelector("img[alt='iPhone 12']")).getAttribute("src");
